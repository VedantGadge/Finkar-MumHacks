      ...
      <div className="splash-frame">
        <div className="splash-card">
          <div className="splash-mark">
            <svg width="250" height="250" viewBox="0 0 250 250" fill="none" xmlns="http://www.w3.org/2000/svg" className="splash-mark-img">
              {/* removed outer circle so CSS background circle shows instead */}
              <mask id="path-2-outside-1_414_27" maskUnits="userSpaceOnUse" x="75.5" y="74.4434" width="88" height="147" fill="black">
                <rect fill="white" x="75.5" y="74.4434" width="88" height="147" />
              ...
              <rect id="bar-2" x="120.441" y="55.168" width="7.72222" height="13.2778" fill="#efefef" stroke="#efefef" strokeWidth="2" />
              <rect id="bar-3" x="135.719" y="48.2227" width="7.72222" height="20.2222" fill="#efefef" stroke="#efefef" strokeWidth="2" />
              <rect id="bar-4" x="151" y="35.7227" width="7.72222" height="32.7222" fill="#efefef" stroke="#efefef" strokeWidth="2" />

              {/* Animated arrow */}
              <path id="logo-arrow" d="M89.5051 58.4391L88.2215 59.2152L89.7738 61.7824L91.0574 61.0063L90.2812 59.7227L89.5051 58.4391ZM150.003 23.6115L132.687 23.962L141.648 38.7837L150.003 23.6115ZM90.2812 59.7227L91.0574 61.0063L139.227 31.8803L138.451 30.5967L137.675 29.3131L89.5051 58.4391L90.2812 59.7227Z" fill="white" stroke="white" strokeWidth="1.5" />
            </svg>
          </div>
