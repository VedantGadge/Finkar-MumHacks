...
import { fetchTickers, generateCaseStudy, getTickerDisplayName, fetchMarketIndices, fetchSectorPerformance, fetchMultipleStockData } from '../utils/stockApi';
    ...
    useEffect(() => {
        const loadTickersAndData = async () => {
            try {
                ...
                const [indices, sectors, tickersData] = await Promise.all([
                    fetchMarketIndices(),
